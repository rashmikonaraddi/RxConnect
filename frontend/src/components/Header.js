    ...
    <header className="bg-gradient-to-r from-[#0b193c] via-[#102454] to-[#0b193c] text-white pt-8 pb-16 px-6 md:px-12 shadow-xl relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
        ...
        <div className="flex items-center gap-4">
          <Link href="/" className="w-13 h-13 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center text-white shadow-inner shrink-0 group hover:scale-105 transition-transform duration-300">
            <svg
